            ...
            <div className={styles.container}>
                ...
                <footer className={styles.sendBox}>
                    ...
                    <div className={styles.msg}>
                        ...
                        <input type="text" onFocus={()=>{setFocus(true)}} placeholder='Type a message' className={styles.typemsg} />
                        <span>
                            <svg style={{display:focus?"none":"block"}} viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24"><title>ptt</title><path fill="currentColor" d="M11.999,14.942c2.001,0,3.531-1.53,3.531-3.531V4.35c0-2.001-1.53-3.531-3.531-3.531 S8.469,2.35,8.469,4.35v7.061C8.469,13.412,9.999,14.942,11.999,14.942z M18.237,11.412c0,3.531-2.942,6.002-6.237,6.002 s-6.237-2.471-6.237-6.002H3.761c0,4.001,3.178,7.297,7.061,7.885v3.884h2.354v-3.884c3.884-0.588,7.061-3.884,7.061-7.885 L18.237,11.412z"></path></svg>
                            <svg style={{ display: focus ? "block" : "none" }} onClick={()=>{setFocus(false)}}  xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M120-160v-640l760 320-760 320Zm80-120 474-200-474-200v140l240 60-240 60v140Zm0 0v-400 400Z" /></svg>
                        </span>
                    </div>
                </footer>
            </div>
